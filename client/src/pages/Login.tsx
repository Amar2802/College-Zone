...
const Login = () => {
  ...
  const handleGoogleAuthSuccess = async (googleToken: string) => {
    setLoading(true);
    try {
      ...
      toast({ title: error.message || "Google login failed", variant: "destructive" });
    } finally {
      setLoading(false);
    }
  };
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <div className="relative mt-1">
                ...
                <Input id="email" type="email" placeholder="you@student.edu" className="pl-10" value={email} onChange={e => setEmail(e.target.value)} />
              </div>
            </div>
            <div>
