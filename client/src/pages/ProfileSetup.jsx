...
const preferences = [
  ...
  },
  {
    ...
    field: "study_habits",
    icon: BookOpen,
    options: ["Library Lover", "Room Studier", "Cafe Goer"],
  },
  {
        ...
        <div className="bg-card rounded-2xl p-8 shadow-card">
              ...
              >
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="e.g. MIT"
                    value={info.college}
                    onChange={e => setInfo(f => ({ ...f, college: e.target.value }))}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    value={info.course}
                    onChange={e => setInfo(f => ({ ...f, course: e.target.value }))}
                  />
                </div>
                <div>
                  <Label>Year</Label>
                  <Input
                    ...
                    value={info.year}
                    onChange={e => setInfo(f => ({ ...f, year: e.target.value }))}
                  />
                </div>
              </motion.div>
            )}
          ...
          <div className="flex justify-between mt-8">
            ...
            <Button type="button" variant="hero" onClick={next} disabled={saving}>
              {step < 2 ? "Next" : saving ? "Saving..." : "Complete"}{" "}
